let login_email = document.getElementById('login-mail') as HTMLInputElement
let login_password = document.getElementById('login-pwd') as HTMLInputElement

let login_form = document.getElementById('login-form') as HTMLFormElement

let email_error = document.querySelector('#mail-error') as HTMLSpanElement
