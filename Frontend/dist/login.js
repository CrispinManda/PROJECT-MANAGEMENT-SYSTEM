"use strict";
let login_email = document.getElementById('login-mail');
let login_password = document.getElementById('login-pwd');
let login_form = document.getElementById('login-form');
let email_error = document.querySelector('#mail-error');
